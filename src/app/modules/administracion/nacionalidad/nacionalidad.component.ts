...
import { ModalNacionalidadComponent } from './modal-nacionalidad/modal-nacionalidad.component';
...
export class NacionalidadComponent implements OnInit {
  ...
  constructor(private http:HttpClient,private toastr: ToastrService,
             ...
             private SidebarComponent:SidebarComponent) {
              ...
              this.SidebarComponent.menuspermiso(7).subscribe(resp=>{
  ...
  editar(item: any) {
    if(this.permisoactualizar){
      ...
      this._dialog.open(ModalNacionalidadComponent, dialogConfig);
  ...
  impo() {
   ...
   <h5>REPORTE</h5>
   <h5>Listado  de Nacionalidades</h5>
   </div>
   </div><br>`;
    printJS({
      printable: 'reporte',
