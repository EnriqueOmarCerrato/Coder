...
import { ModalParentescoComponent } from './modal-parentesco/modal-parentesco.component';
...
export class ParentescoComponent implements OnInit {
  ...
  constructor(private http:HttpClient,private toastr: ToastrService,
             ...
             private SidebarComponent:SidebarComponent) {
              ...
              this.SidebarComponent.menuspermiso(9).subscribe(resp=>{
  ...
  editar(item: any) {
    ...
    this._dialog.open(ModalParentescoComponent, dialogConfig);
