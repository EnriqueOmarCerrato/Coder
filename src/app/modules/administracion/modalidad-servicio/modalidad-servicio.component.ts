...
@Component({
  selector: 'app-modalidad-servicio',
  templateUrl: './modalidad-servicio.component.html',
  styleUrls: ['./modalidad-servicio.component.scss']
})
export class ModalidadServicioComponent implements OnInit {
  loading=true;
  loadingConfig=true;
  mostrarModal=false;
  data:any;
  ...
  constructor(private http:HttpClient,private toastr: ToastrService,
             ...
             private SidebarComponent:SidebarComponent) {
              ...
              this.SidebarComponent.menuspermiso(16).subscribe(resp=>{
  ...
  editar(item: any) {
    if(this.permisoactualizar){
      ...
      this._dialog.open(ModalServicioComponent, dialogConfig);
